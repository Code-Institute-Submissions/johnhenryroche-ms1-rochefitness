# ReadMe for Roche Fitness

[View the Live Project Here](#)

This project comprises a multi-page website for a fictional new gym called Roche Fitness which is located in Deansgrange in South Dublin. 
The website has been designed to be responsive, intuitive and accessible on a range of media devices, in order to make it easy for current and prospective members of the gym to navigate and source information.

Photo with Laptop, Ipad and Iphone to be inputted.

# User Experience (UX)
## User stories:

### First Time Visitor Goals
1. As a First Time Visitor, I want to quickly establish what services the gym offers and what is the process for joining as a member. 
2. As a First Time Visitor, I want to be able to easily navigate throughout the site pages and find key information about the location of the gym and contact details for enquiries.
3. As a First Time Visitor, I want to look for testimonials to understand what the users of the gym think of it and whether it would suit me to apply.

### Returning Visitor Goals
1. As a Returning Visitor, I want to find information about new classes or updated facilities since my last visit.
2. As a Returning Visitor, I want to find the best way to get in contact with the organisation with any questions I may have (as a prospective or current member).
3. As a Returning Visitor, I want to be able to see the key information in respect of opening hours and parking.
...
3. As a Frequent User, I want to check if opening hours remain the same or enquire about specific queries (e.g. is gym open on a bank holiday)

## Design

### Colour Scheme
- The site has a generally dark colour with varying shades of black, white, fuschia, red and pink being the main colours, as these go well with the logo that I created for the gym, as well as the dark tones of the images that I selected.
